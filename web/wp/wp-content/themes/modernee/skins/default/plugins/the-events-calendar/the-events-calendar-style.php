...
if ( ! function_exists( 'modernee_tribe_events_get_css' ) ) {
	add_filter( 'modernee_filter_get_css', 'modernee_tribe_events_get_css', 10, 2 );
	function modernee_tribe_events_get_css( $css, $args ) {
