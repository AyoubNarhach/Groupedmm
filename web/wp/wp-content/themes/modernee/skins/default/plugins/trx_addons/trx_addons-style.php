...
if ( ! function_exists( 'modernee_trx_addons_get_css' ) ) {
	add_filter( 'modernee_filter_get_css', 'modernee_trx_addons_get_css', 10, 2 );
	function modernee_trx_addons_get_css( $css, $args ) {
