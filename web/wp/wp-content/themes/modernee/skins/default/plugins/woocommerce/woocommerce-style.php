...
if ( ! function_exists( 'modernee_woocommerce_get_css' ) ) {
	add_filter( 'modernee_filter_get_css', 'modernee_woocommerce_get_css', 10, 2 );
	function modernee_woocommerce_get_css( $css, $args ) {
...
$fdir = modernee_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
