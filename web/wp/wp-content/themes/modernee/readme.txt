...
Please install and activate it before starting to use the theme Modernee.
...
Theme documentation is available on https://doc.themerex.net/modernee/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Modernee is Fontello.
