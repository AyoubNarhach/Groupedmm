...
if ( ! function_exists( 'modernee_storage_get' ) ) {
	/**
	 ...
	 */
	function modernee_storage_get( $var_name, $default = '' ) {
		global $MODERNEE_STORAGE;
		return isset( $MODERNEE_STORAGE[ $var_name ] ) ? $MODERNEE_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'modernee_storage_set' ) ) {
	/**
	 ...
	 */
	function modernee_storage_set( $var_name, $value ) {
		global $MODERNEE_STORAGE;
		$MODERNEE_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'modernee_storage_empty' ) ) {
	/**
	 ...
	 */
	function modernee_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $MODERNEE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $MODERNEE_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $MODERNEE_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'modernee_storage_isset' ) ) {
	/**
	 ...
	 */
	function modernee_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $MODERNEE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $MODERNEE_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $MODERNEE_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'modernee_storage_unset' ) ) {
	/**
	 ...
	 */
	function modernee_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $MODERNEE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			if ( isset( $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] ) ) {
				unset( $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] );
			}
		} elseif ( '' !== $key ) {
			if ( isset( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
				unset( $MODERNEE_STORAGE[ $var_name ][ $key ] );
			}
		} else {
			if ( isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
				unset( $MODERNEE_STORAGE[ $var_name ] );
			}
		}
	}
}

if ( ! function_exists( 'modernee_storage_inc' ) ) {
	/**
	 ...
	 */
	function modernee_storage_inc( $var_name, $value = 1 ) {
		global $MODERNEE_STORAGE;
		if ( empty( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = 0;
		}
		$MODERNEE_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'modernee_storage_concat' ) ) {
	/**
	 ...
	 */
	function modernee_storage_concat( $var_name, $value ) {
		global $MODERNEE_STORAGE;
		if ( empty( $MODERNEE_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'modernee_storage_get_array' ) ) {
	/**
	 ...
	 */
	function modernee_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $MODERNEE_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ? $MODERNEE_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'modernee_storage_set_array' ) ) {
	/**
	 ...
	 */
	function modernee_storage_set_array( $var_name, $key, $value ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $MODERNEE_STORAGE[ $var_name ] ) ) {
			if ( '' === $key ) {
				$MODERNEE_STORAGE[ $var_name ][] = $value;
			} else {
...
if ( ! function_exists( 'modernee_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function modernee_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
			$MODERNEE_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( is_array( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
			if ( '' === $key2 ) {
				$MODERNEE_STORAGE[ $var_name ][ $key ][] = $value;
			} else {
				$MODERNEE_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
			}
		}
	}
}

if ( ! function_exists( 'modernee_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function modernee_storage_merge_array( $var_name, $key, $value ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$MODERNEE_STORAGE[ $var_name ] = array_merge( $MODERNEE_STORAGE[ $var_name ], $value );
		} else {
			$MODERNEE_STORAGE[ $var_name ][ $key ] = array_merge( $MODERNEE_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'modernee_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function modernee_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			modernee_array_insert_after( $MODERNEE_STORAGE[ $var_name ], $after, $key );
		} else {
			modernee_array_insert_after( $MODERNEE_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'modernee_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function modernee_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			modernee_array_insert_before( $MODERNEE_STORAGE[ $var_name ], $before, $key );
		} else {
			modernee_array_insert_before( $MODERNEE_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'modernee_storage_push_array' ) ) {
	/**
	 ...
	 */
	function modernee_storage_push_array( $var_name, $key, $value ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $MODERNEE_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
				$MODERNEE_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $MODERNEE_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'modernee_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function modernee_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $MODERNEE_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $MODERNEE_STORAGE[ $var_name ] ) && is_array( $MODERNEE_STORAGE[ $var_name ] ) && count( $MODERNEE_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $MODERNEE_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $MODERNEE_STORAGE[ $var_name ][ $key ] ) && is_array( $MODERNEE_STORAGE[ $var_name ][ $key ] ) && count( $MODERNEE_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $MODERNEE_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'modernee_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function modernee_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( empty( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
			$MODERNEE_STORAGE[ $var_name ][ $key ] = 0;
		}
		$MODERNEE_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'modernee_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function modernee_storage_concat_array( $var_name, $key, $value ) {
		global $MODERNEE_STORAGE;
		if ( ! isset( $MODERNEE_STORAGE[ $var_name ] ) ) {
			$MODERNEE_STORAGE[ $var_name ] = array();
		}
		if ( empty( $MODERNEE_STORAGE[ $var_name ][ $key ] ) ) {
			$MODERNEE_STORAGE[ $var_name ][ $key ] = '';
		}
		$MODERNEE_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'modernee_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function modernee_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $MODERNEE_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $MODERNEE_STORAGE[ $var_name ] ) ? $MODERNEE_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $MODERNEE_STORAGE[ $var_name ] ) ? $MODERNEE_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'modernee_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function modernee_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $MODERNEE_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $MODERNEE_STORAGE[ $var_name ]->$prop ) ? $MODERNEE_STORAGE[ $var_name ]->$prop : $default;
	}
}
